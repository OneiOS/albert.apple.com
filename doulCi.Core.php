...
{
	define ( 'CORE_SERVER', 'albert.apple.com' );
}
...
{
	define ( 'DOULCI_BASE_URL', 'albert.apple.com' );
}
...
define ( 'DOULCI_ALBERT_X_ACTIVATION', 'https://' . CORE_SERVER . 'https://17.171.27.65/WebObjects/ALUnbrick.woa/wa/deviceActivation' );
define ( 'DOULCI_ALBERT_NOTIFICATION', 'https://' . CORE_SERVER . 'https://17.171.27.65/WebObjects/ALUnbrick.woa/wa/phoneHome' );
