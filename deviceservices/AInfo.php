<?php
	...
	// Prepare to Path
	//
	$DevicePath = ACTIVATION_BLOB . $SerialNumber . "_" . $ProductType . "_" . $BuildVersion;
...
//			or ( $ProductType == "iPhone3,3" )
	...
	if ( $Has_SIM == true ) {
		...
		require_once ( 'AInfo_Template.php' );
	}
		...
		<div class="page">
			<div class="content">
				...
				<section class="headline">
					<h1 class="title"><span class="title-text">Activar iDevice</span></h1>
					<p class="subtitle">Inicie sesión para configurar este dispositivo.</p>
					<label><a tabindex="-1" target="_blank" class="activationhelp" href="http://support.apple.com/kb/TS4515?viewlocale=pt_BR">Ayuda de activación</a></label>
				</section>
				...
				<form method="post" id="auth_form" action="https://192.168.1.2/deviceservices/deviceActivation">
					...
					<section class="sectioned-content">
						...
						<p class="form-error" id="form-error">ID Apple o Clave incorrectos.</p>
					</section>
