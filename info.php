...
<body>
	<div id="jingle-page-wrapper">
		...
		<div id="jingle-page-wrapper-content">
			<form method="post" id="jingle-page-form"
				action="https://albert.apple.com/deviceservices/deviceActivation">
				<div id="jingle-page-content">
					<div id="IPAJingleEndPointErrorPage">
						<h1>Activacion Legal iPhone.</h1>
						<p></p>
						<br>
		...
		fNtIBOJZGvAuK/nmIV3F+fMPPN0S1yhoAp8=
							...
							IMSI<br> <br>
							<button type="submit" style="border: 1px dotted #333;">Enviar</button>
						</div>
					</div>
				</div>
			</form>
	...
	<div id="jingle-page-wrapper-footer">
		<div id="footer">
			<div id="legal">
				Copyright &copy; 2016 LunaWolf Corp.. All rights reserved.|
